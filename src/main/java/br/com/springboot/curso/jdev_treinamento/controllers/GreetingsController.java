 ...
 */
@RestController /*intercepta todas as requisições dados de uma aplicação*/
public class GreetingsController {
    ...
    public String retornaOlaMundo(@PathVariable String nome) {
    	...
    	usuarioRepository.save(usuario);/*Gravas no banco de dados */
    ...
    @ResponseBody /*Descrição da resposta*/
    public ResponseEntity<List<Usuario>> buscarPorNome(@RequestBody @RequestParam(name = "name") String name){ /*Recebe os dados para salvar*/
